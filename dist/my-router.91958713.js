...
function readyHandler() {
  ...
  var myContentDom = document.getElementById("myContent");
  ...
  document.getElementById("historyBlock").addEventListener("click", function (e) {
    // 阻止链接点击默认跳转事件
    e.preventDefault();
    // 添加历史，实现浏览器前进后退
...
//# sourceMappingURL=/my-router.91958713.map